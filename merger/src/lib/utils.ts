...
/**
 * Align messages to the left and right of the terminal
 * @param left String on the left
 * @param right String on the right
 * @param fullWidth Optional custom terminal width
 * @returns Combined and aligned strings
 */
export function alignToSides(left: string, right: string, fullWidth = 80): string {
